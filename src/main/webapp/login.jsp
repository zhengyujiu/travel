...
<head>
    ...
    <link rel="icon" href="statics/imgs/favicon.png" type="image/png"><!-- Font Awesome -->
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="input-email" placeholder="请输入用户名">
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    <button type="button" class="btn btn-block btn-primary">登录</button></div>
                            </form>
                        </div>
