        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <c:if test="${requestScope.IsLogin==1}">
                    <li><a href="logOutServlet" style="position: relative;left: 455">退出登录</a></li>
                </c:if>
...
<div id="cancelCanteenChoose">
    <a href="cancelChooseOrderServlet?chooseCanteen=-1">取消餐厅选择?</a>
</div>

<div id="searchCity">
    <c:if test="${sessionScope.chooseAttraction==null}">
        <form class="bs-example bs-example-form" role="form" action="orderCanteenServlet" method="get">
            <div class="row">
                <div class="col-lg-3">
    ...
    <c:if test="${sessionScope.chooseAttraction!=null}">
        <div class="btn-group" id="distance">
            ...
            <ul class="dropdown-menu" role="menu">
                <li>
                    <a href="orderCanteenServlet?ahDistance=200">200米内</a>
                </li>
                <li>
                    <a href="orderCanteenServlet?ahDistance=500">500米内</a>
                </li>
                <li>
                    <a href="orderCanteenServlet?ahDistance=1000">1km内</a>
                </li>
                <li class="divider"></li>
                <li>
                    <a href="orderCanteenServlet?ahDistance=2000">2km及以上</a>
                </li>
            </ul>
        </div>
    </c:if>
...
<div style="margin-top: 50px">
    <table class="table table-hover" id="show">
        ...
        <tbody>
        <c:forEach items="${requestScope.canteenList}" var="canteen">
            <tr>
                <td>${canteen.rcname}</td>
                <td><img src="statics/pagephone/canteen/${canteen.rcpicture}" width="150px" height="150px"/></td>
                <td>${canteen.rcaddress}</td>
                <td>${canteen.rcintroduce}</td>
                <td>${canteen.rcphone}</td>
                <td>${canteen.rctime}</td>
