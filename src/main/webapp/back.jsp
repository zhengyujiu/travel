  ...
  <style>
    ...
    <script>
        $(function (){
            ...
            $("#loginAndQuit").bind("click",function (){
  ...
  <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item" id="orderManage">
            ...
            <li class="nav-item" id="loginAndQuit">
                <a class="nav-link" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M15 15l3.35 3.35" /><path d="M9 15l-3.35 3.35" /><path d="M5.65 5.65l3.35 3.35" /><path d="M18.35 5.65l-3.35 3.35" /></svg>
                  </span>
                    <span class="nav-link-title">
    ...
    <div class="page-wrapper" >
        <div style="position: relative;left: 0px" id="myDiv">
            <iframe src="userManagerServlet" id="myIframe" >
            </iframe>
        </div>
    </div>
</div>
